package com.example.ui_ux_design.Adapter;
...
public class TrendsAdapter extends RecyclerView.Adapter<TrendsAdapter.ViewHolder> {
    ArrayList<TrensDomain> items;
    Context context;

    public TrendsAdapter(ArrayList<TrensDomain> items) {
        this.items = items;
    }
    ...
    public TrendsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View inflator = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_tm,parent,false);
    ...
    public void onBindViewHolder(@NonNull TrendsAdapter.ViewHolder holder, int position) {
        ...
        int drawableRecouseholder=holder.itemView.getResources().getIdentifier(items.get(position).getPicAddress(),
                "drawable",holder.itemView.getContext().getPackageName());
        Glide.with(holder.itemView.getContext())
                .load(drawableRecouseholder)
